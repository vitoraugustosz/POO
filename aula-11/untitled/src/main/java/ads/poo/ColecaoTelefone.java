...
public class ColecaoTelefone {
    ...
    private final String EXPRESSAO_REGULAR = "(##) # ####-####";
    public boolean add(String rotulo, String valor){
        if(dados.containsValue(valor)){ //Para não repetir o próprio número, evitar dois rótulos com mesmo número
           return false;
        }
    ...
    //Printar de acordo com a formatação adequada de números. Ou adicionar os númeors já formatados
    @Override
